...
(function(){
	...
	var GameBoardGraphics = function(renderer, rendererContext){
		...
		this._xMarkRadius = window.ttt.settings.BOARD_FX_X_MARK_RADIUS;
		this._oMarkRadius = window.ttt.settings.BOARD_FX_O_MARK_RADIUS;
		this._markLineStyle = window.ttt.settings.BOARD_FX_MARK_LINE_STYLE;
